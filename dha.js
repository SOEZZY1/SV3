...
petik = '```'
fake = 'CREATOR BOT\©Zx1Bot'//GANTI NAMA KAMU BEP
ban =[]
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya Zx1-Bot,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©Zx1Bot`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`MAU BELI SC INI HUBUNGIN ZX1 WA 6282352372885\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Zx1-Bot\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI LORD ©Zx1Bot\`\`\`')
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Zx1Bot* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Zx1-Bot ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`Jangan Lupa Subscribe YT Owner:\n https://youtube.com/channel/UCzIxvGCoNWeiirdcRkc8oaA`)
              break
       case 'masukandata':
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN Zx1-Bot」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
case 'tahta':
         ...
         break    
case 'pornhub':
         if (args.length == 0) return reply(`Contoh: ${prefix + command} Zx1-Bot`)
         txt1 = args[0]
         txt2 = args[1]
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
             reply(`DANA : 6282352372885\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break
           case 'gopay':
             reply(`GOPAY : 6282352372885\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break  
         case 'pulsa':
             reply(`PULSA : 6282352372885\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break              
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/refgame_`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/DhpBTuej45tIrDxVjZ2hPN')
             break
      case 'ownermenu':
